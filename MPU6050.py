...
class mpu6050:
    ...
    def set_filter_range(self, filter_range=FILTER_BW_98):
    ...
    def update_angles(self):
        ...
        self.angGyroX += gyroXRate * interval * 1.2
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if current_time - last_print_time >= 0.5:
            ...
            print(f"X Angle: {angles['x']:.1f}, Y Angle: {angles['y']:.1f}, Z Angle: {angles['z']:.1f}")
